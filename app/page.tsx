      ...
      <section className="mx-auto max-w-7xl px-6 py-20 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p className="mt-6 text-white/80 max-w-prose">
            Shifu reúne en un solo lugar la información de los docentes:
            perfiles completos, materias y trayectoria. Guarda tus favoritos,
            recibe resúmenes automáticos (IA) y mantente al día con nuevas
            materias y logros.
          </p>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="rounded-2xl border border-white/10 bg-[#121621] p-6 hover:border-white/20 transition">
          ...
          <p className="mt-3 text-white/70">
            Descubre perfiles con biografía, materias, trayectoria y
            estadísticas de desempeño para tomar decisiones informadas.
          </p>
        </div>
        ...
        <div className="rounded-2xl border border-white/10 bg-[#121621] p-6 hover:border-white/20 transition">
          ...
          <p className="mt-3 text-white/70">
            Guarda profesores como favoritos, compáralos por materias y
            valoración, y arma tu lista personal para cursos futuros.
          </p>
        </div>
        ...
        <div className="rounded-2xl border border-white/10 bg-[#121621] p-6 hover:border-white/20 transition">
          ...
          <p className="mt-3 text-white/70">
            Mantente al día con resúmenes automáticos (IA) y alertas sobre
            nuevas materias, reconocimientos y actualizaciones relevantes en
            cada perfil.
          </p>
        </div>
      </section>
