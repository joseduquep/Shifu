...
describe('ProfessorCard Component - Lógica', () => {
	...
	test('debe formatear calificaciones correctamente', () => {
		...
		expect(formatRating(undefined)).toBe('Sin calificación')
	})
	...
	test('debe formatear materias correctamente', () => {
		...
		expect(formatSubjects(['Cálculo I', 'Cálculo II'])).toBe('Cálculo I, Cálculo II')
		expect(formatSubjects(['Cálculo I', 'Cálculo II', 'Álgebra'])).toBe('Cálculo I, Cálculo II, Álgebra')
		expect(formatSubjects(['Cálculo I', 'Cálculo II', 'Álgebra', 'Física'])).toBe('Cálculo I, Cálculo II, Álgebra y 1 más')
	})
